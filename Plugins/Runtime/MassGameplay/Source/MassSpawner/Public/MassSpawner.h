...
public:
	...
	// @third party code - VA ITMO - Simplified agents count configuration
	// If bigger than -1, will override Spawn Count setting from the generator.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Spawning")
	int32 SpawnCountOverride = -1;

	// Index of a goal point that agents spawned by this spawner will go to.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Spawning")
	int32 GoalPointIndexTest = 0;
